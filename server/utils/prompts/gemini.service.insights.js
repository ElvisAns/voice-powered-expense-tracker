...
async function run(userinput) {
    const parts = [
        { text: `I will give you a informations about my spendings/earning in the last 7 days the you will have to extract some insights for me.
            ...
            If no enough information is provided just encourage me to keep tracking my transactions with in our Expense tracking app to get useful insights from you.
            `
        }, {
