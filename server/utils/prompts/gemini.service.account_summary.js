...
async function run(userinput) {
    const parts = [
        {
            text: `I will give data in json format that represent all my spendings/earning and i want you to tell me back the total spent amount and income per every account and every currency.
        example :
